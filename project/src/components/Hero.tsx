  ...
  return (
    <>
      <div id="home" className="relative bg-white pt-16">
        <div className="absolute inset-0 h-[600px] sm:h-[500px] md:h-[600px]">
          <img
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-32">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white">
              ...
              <span className="block text-blue-200 mt-2">For Your Family</span>
            </h1>
            <p className="mt-6 max-w-lg mx-auto text-lg sm:text-xl text-blue-100 sm:max-w-3xl">
            ...
            <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div className="space-y-4 sm:space-y-0 sm:space-x-4">
                <button
                  ...
                  className="group w-full sm:w-auto flex-none bg-blue-600 text-white text-lg font-semibold py-3 px-8 rounded-full hover:bg-blue-700 transition-all duration-200 inline-flex items-center justify-center"
                >
                  Book Appointment
                ...
                <button
                  ...
                  className="w-full sm:w-auto flex-none bg-white text-blue-900 text-lg font-semibold py-3 px-8 rounded-full hover:bg-gray-50 transition-colors"
                >
                  Emergency Care
                </button>
              </div>
            ...
            <div className="group bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm sm:text-base text-gray-600">24/7 Emergency Care</p>
                  <p className="text-sm sm:text-base text-gray-600">Mon-Fri: 8:00 - 20:00</p>
                </div>
              </div>
            </div>
            <div className="group bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900">Emergency Line</h3>
                  <p className="text-sm sm:text-base text-gray-600">+254 722 123 456</p>
                  <p className="text-sm sm:text-base text-gray-600">Available 24/7</p>
                </div>
              </div>
            </div>
            <div 
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm sm:text-base text-gray-600">Ngong Road</p>
                  <p className="text-sm sm:text-base text-gray-600">Opposite Prestige Plaza</p>
                </div>
              </div>
            </div>
          </div>
